  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="banner" --><img src="/campaigns/hot/images/banner03.jpg" alt="Save the Planet – Get Your HOT Pack Today!" width="724" height="249"><!-- InstanceEndEditable -->
          <div id="content"><!-- InstanceBeginEditable name="content" -->
            <h1>Save the Planet – Get Your HOT Pack Today!</h1>
            <p>Send for your <a href="#" onclick="javascript: window.open('http://timetogoveggie.com/orderpack.php?i=31','OrderPack','scrollbars=yes,width=370,height=500')">FREE HOT! pack</a> containing more facts on the environment, two posters and information on going veggie, including recipes.</p>
            <p>Or choose our great value Bumper HOT! Pack containing:</p>
            <p>• HOT! Posters<br>
              • Viva!’s Diet of Disaster – an easy to read, colourful guide to the environment – worth £3.50<br>
              • Martin Shaw Cooks Veggie – 28 pages of delicious animal-free recipes worth £1<br>
              • Get Healthy with Heather – the ultimate 70- page guide to going vegan worth £2.90</p>
            <p>Total value is £9.50 (inc p&amp;p) but <a href="http://www.viva.org.uk/vivashop/productlist.php?category=4&parent=1">
order on-line</a> today and it can be yours for just £4.50 (inc p&amp;p).</p>
            <!-- InstanceEndEditable -->
