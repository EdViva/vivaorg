...
<!-- AddThis Button END --></div>
          <!-- InstanceBeginEditable name="content" --><img src="/christmas/food_images/lemon-cheesecake.jpg" alt="" width="300" height="201" class="floatr">
          <h1>Recipes</h1>
          <h2><strong>Lemon ‘Cheesecake’ with Blueberries</strong></h2>
          <p>&nbsp;Serves 4-6 <br>
            Preparation and ‘cooking’ time: 10-15 minutes<br>
            No need to miss out on creamy cheesecake with this divinely simple, animal-free recipe from Rose Elliot! It’s incredibly quick and can be made and chilled the day before. <br>
            175g/6oz ginger biscuits (most supermarket ‘Value’ ginger biscuits are vegan)<br>
            75g/3oz vegan margarine, melted <br>
            400g/15oz vegan cream cheese, such as Tofutti or Sheese, available from health food shops<br>
            Finely grated rind of 2 lemons <br>
            25g/1oz caster sugar <br>
            175g/6oz blueberries – or raspberries if preferred <br>
            Icing sugar to dredge <br>
            Mint leaves to decorate (optional) </p>
          <ol start="1" type="1">
            <li>Put the      biscuits into a polythene bag, secure lightly then crush with a rolling      pin.&nbsp;</li>
            <li>Transfer      the crushed biscuits to a bowl, add the melted margarine and mix to      combine. </li>
            <li>Press the      mixture into a 20cm/8 inch flan tin with a removable base. (Don’t attempt      to go up the sides of the tin.) </li>
            <li>Place in      the freezer or fridge while you prepare the topping. </li>
            <li>Put the      cheese into a bowl and add the lemon rind and caster sugar. </li>
            <li>Stir to      make a creamy mixture. </li>
            <li>Spoon the      cream cheese mixture into the flan tin. </li>
            <li>Take it to      the edges but don’t try to smooth the surface.&nbsp; </li>
            <li>Put into      the fridge until required. </li>
            <li>To finish,      lift the cheesecake out of the tin and place the cheesecake on a serving      dish. </li>
            <li>Decorate      the tops with blueberries or raspberries and a sprig of mint. </li>
            <li>Dust with      icing sugar, and serve as soon as possible. </li>
          </ol>
          <h2>&nbsp;</h2>
          <!-- InstanceEndEditable -->
