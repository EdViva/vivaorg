...
<!-- AddThis Button END --></div>
          <!-- InstanceBeginEditable name="content" --><img src="/christmas/food_images/red-cabbage-stirfry.jpg" alt="" width="300" height="200" class="floatr">
          <h1>Recipes</h1>
          <h2><strong>Red Cabbage, Beetroot &amp; Apple Sauté </strong></h2>
          <p>Serves 4</p>
          <p>60 minutes</p>
          <p>This lovely, colourful dish is a fantastic accompaniment to just about any roast dinner<br>
              <br>
            40g/1½oz vegetable margarine<br>
            ½ a red cabbage, finely shredded<br>
            1tbsp chopped fresh thyme<br>
            1tsp ground mixed spice<br>
            1tbsp brown sugar<br>
            150ml/5fl oz pint red wine<br>
            3tbsp balsamic vinegar<br>
            2 dessert apples<br>
            225g/8oz cooked beetroot, cubed<br>
            50g/2oz pecan nuts, toasted<br>
            Salt and pepper</p>
          <ol start="1" type="1">
            <li>Melt margarine and fry cabbage, spices and sugar for 10 minutes. </li>
            <li>Add wine and vinegar and bring to boil. </li>
            <li>Cover pan and cook over a low heat for 20 minutes.</li>
            <li>Core and thickly slice apples and fry gently in a little more      margarine until golden.</li>
            <li>Add to cabbage and cook for a further 20 minutes until tender.</li>
            <li>Stir in beetroot and cashew nuts. </li>
            <li>Heat through. Season and serve.</li>
          </ol>
          <!-- InstanceEndEditable -->
