...
<!-- AddThis Button END --></div>
          ...
          <img src="/christmas/food_images/tropical-Jelly.jpg" alt="" width="200" height="267" class="floatr">
          <h1>Recipes</h1>
          <h2><strong>Tropical Jelly with Peach &amp; Raspberry Coulis </strong></h2>
          <p>            Serves 4</p>
          <p>70 minutes, including 1 hour chilling time. You can make the coulis while the jellies are cooling in the fridge</p>
          <p>For the jelly:<br>
            500ml white grape or apple juice<br>
            1 sachet of Vege-gel (eg Supercooks, from most supermarkets)<br>
            ½ tin mandarin segments<br>
            1 large kiwi fruit<br>
            125g white seedless grapes</p>
          <p>For the coulis:<br>
            ½ tin peach halves in fruit juice<br>
            50g frozen raspberries</p>
          <ol start="1" type="1">
            <li>Peel the kiwi and cut it into small pieces and halve the      grapes. </li>
            <li>Divide the kiwi, grapes and mandarin segments between four      bowls. </li>
            <li>Porcelain bowls are best if you want to turn the jellies out      for serving.</li>
            <li>Follow the Vege-gel instructions to make the jelly with the      juice. Add a little sugar or natural sweetener if you want.</li>
            <li>Pour the warmed juice over the fruit and let the jellies sit in      a cool place. Once they have cooled down chill them in the fridge for one      hour.</li>
            <li>To make the fruit coulis, blend the peach halves with a hand blender      and set the puree aside.</li>
            <li>Liquidise the frozen raspberries with a little of the peach      juice. Both fruit purees are naturally sweet but you can add a little      sugar to taste.</li>
          </ol>
          <p>&nbsp;</p>
          <p>Thanks to Chava Eichener for the recipe. </p>
          <h2>&nbsp;</h2>
          <h2>&nbsp;</h2>
          <!-- InstanceEndEditable -->
