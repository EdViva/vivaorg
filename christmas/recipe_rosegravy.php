...
<!-- AddThis Button END --></div>
          <!-- InstanceBeginEditable name="content" --><img src="/christmas/food_images/roses-Gravy.jpg" alt="" width="200" height="204" class="floatr">
          <h1>Recipes</h1>
          <h2><strong>Rose’s Gravy</strong></h2>
          <p>            Another sure-fire recipe from Rose Elliot – one of those invaluable ‘staples’ that works whatever the meal. </p>
          <p>30 minutes total preparation and cooking time</p>
          <p>1 onion, diced<br>
            2 tbsp oil<br>
            2 tbsp plain flour<br>
            Clove of garlic (crushed)<br>
            450ml/15 fl oz vegetable stock<br>
            1 tsp yeast extract<br>
            1 or 2 tbsp soya sauce<br>
            Freshly ground black pepper </p>
          <ol start="1" type="1">
            <li>Fry the onion in the oil for 5 minutes.</li>
            <li>Add the flour and cook for a further 5 to 10 minutes until the      flour and onion are nut- brown and the onion is soft and slightly pulpy.</li>
            <li>Add the garlic then gradually stir in the vegetable stock (or      the water from any vegetables you happen to be boiling at the same time). </li>
            <li>Bring to the boil and simmer for 10 minutes.</li>
            <li>Add the yeast extract, soya sauce and black pepper. </li>
            <li>Stir well. Strain if you like, or serve as it is.</li>
          </ol>
          <p>From Rose Elliot’s <em>Vegetarian Cookery</em></p>
          <h2>&nbsp;</h2>
          <!-- InstanceEndEditable -->
