...
<!-- AddThis Button END --></div>
          <!-- InstanceBeginEditable name="content" --><img src="/christmas/food_images/onion.jpg" alt="" width="160" height="196" class="floatr">
          <h1>Recipes</h1>
          <h2><strong>Onion Tart Tatin </strong></h2>
          <p>            Serves 4-6<br>
              <br>
            55 minutes, including preparation, cooking and baking time</p>
          <p>Beautiful and very simple. </p>
          <p>6 large red onions<br>
            75g/3oz vegetable margarine<br>
            250g/9oz ready-rolled short crust pastry or equivalent home-made<br>
            Salt and pepper<br>
            A little freshly grated nutmeg (optional)</p>
          <ol start="1" type="1">
            <li>Peel onions and slice into wedges. </li>
            <li>Melt 50g/2oz of margarine in pan with a lid and fry the onions,      stirring occasionally until soft and golden.</li>
            <li>Remove the lid and increase heat, stirring constantly until the      onions are sticky and glazed. </li>
            <li>Season to taste, adding nutmeg if desired.</li>
            <li>Brush in a 23cm/9in round tart tin (fixed base) with remaining      spread, put onions into tin and cover with pastry, pressing down and      trimming the edges.</li>
            <li>Bake at 220ºC/425ºF/Gas Mark 7, for about 25 minutes until      golden.</li>
            <li>Run a knife around the edge of tin, hold a plate over and turn      the tart out. </li>
