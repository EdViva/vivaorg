...
<!-- AddThis Button END --></div>
          <!-- InstanceBeginEditable name="content" --><img src="/christmas/food_images/greenbeans.jpg" alt="" width="300" height="199" class="floatr">
          <h1>Recipes</h1>
          <h2><strong>Giant Mushroom &amp; Green Bean Ragout </strong></h2>
          <p>            Serves 4</p>
          <p>50-60 minutes including preparation time</p>
          <p>Lovely as a main course or side dish.&nbsp; The Madeira or sherry gives it a rather special flavour.</p>
          <p>2 tbsp olive oil<br>
            450g/1 pound large mushrooms, stems removed and caps cut into ½ inch dice<br>
            ½ cup dry Madeira or sherry <br>
            3 shallots, chopped<br>
            1 celery stalk, chopped fine<br>
            500ml/28fl oz vegetable stock, reduced over medium-high heat to half the quantity<br>
            Salt and freshly ground black pepper<br>
            225g/8oz green beans, ends trimmed and cut into 1 inch pieces<br>
            1 tbsp cornstarch dissolved in 2 tbsp water<br>
            1 tbsp minced fresh tarragon or parsley leaves</p>
          <ol start="1" type="1">
            <li>Heat 1 tbsp of the olive oil in a large skillet over medium      heat. </li>
            <li>Add the mushrooms and cook until browned all over (about 5      minutes). </li>
            <li>Add ¼ cup of the Madeira, tossing to coat. Set aside.</li>
            <li>Heat the remaining 1 tbsp olive oil in a large saucepan over      medium heat. </li>
            <li>Add the shallots and celery, cover, and cook, stirring      occasionally, until tender, about 10 minutes. </li>
            <li>Stir in the remaining ¼ cup Madeira, the stock, and salt and      pepper to taste and bring to boil over medium-high heat. </li>
            <li>Add the green beans, reduce the heat to medium, and simmer until      the beans are tender and the liquid is reduced slightly (about 20      minutes).</li>
            <li>Whisk in the cornstarch mixture and cook, stirring, until      thickened (about 2 minutes). </li>
            <li>Add the mushrooms and tarragon, reduce the heat to low and      simmer for five minutes to blend the flavours. </li>
            <li>Serve hot.</li>
          </ol>
          <p>Adapted from <em>Vegan Planet </em>by Robin Robertson, available from VVF, £11.99</p>
          <h2>&nbsp;</h2>
          <h2>&nbsp;</h2>
          <!-- InstanceEndEditable -->
