...
<!-- AddThis Button END --></div>
          <!-- InstanceBeginEditable name="content" --><img src="/christmas/food_images/marmite-roast-potatoes.jpg" alt="" width="200" height="251" class="floatr">
          <h1>Recipes</h1>
          <h2><strong>Marmite Roast Potatoes </strong></h2>
          <p>Serves 4<br>
              <br>
            60 minutes, including preparation, parboiling and roasting time</p>
          <p>A simple variation on an old favourite – you’ll be amazed at how good these are!</p>
          <p>675g/11⁄2lbs peeled potatoes <br>
            1 heaped tsp yeast extract (such as Marmite) <br>
            Vegetable oil</p>
          <ol start="1" type="1">
            <li>Preheat oven to 200ºC/400ºF/Gas Mark 6. </li>
            <li>Quarter potatoes and parboil in salted water for 7 minutes. </li>
            <li>Drain and return to pan with yeast extract. </li>
            <li>Hold a lid over pan and shake so potatoes are roughened and      covered with yeast extract.</li>
            <li>Add enough oil to a roasting tin to cover the base.</li>
            <li>Add potatoes and turn in the oil. </li>
            <li>Roast in the oven for about 45 minutes until golden and crispy.</li>
          </ol>
          <h2>&nbsp;</h2>
          <h2>&nbsp;</h2>
          <!-- InstanceEndEditable -->
